...
SECRET_KEY = 'django-insecure-8-mvvssd-f9k29_eua3$%jinvi10+mke53_z6fz7%v^f0(lpq%'
...
INSTALLED_APPS = [
    ...
    'rest_framework',
    'corsheaders',      # <-- make sure this is present
    'api',          # <-- Your API App
]

# =================================================================
# REST FRAMEWORK & PARSER FIX (CRITICAL)
# =================================================================
REST_FRAMEWORK = {
    'DEFAULT_AUTHENTICATION_CLASSES': (
        'rest_framework_simplejwt.authentication.JWTAuthentication',
    ),
    # CRITICAL FIX: Explicitly tell DRF to accept JSON input from the frontend.
    # This prevents the 401/400 errors when reading the username/password fields.
...
# =================================================================
# JWT Configuration and Customization (Standard Best Practice)
# =================================================================
SIMPLE_JWT = {
